...
exports.validateImageBuffer = void 0;
const constants_1 = require("../config/constants");
const isAllowedMimeType = (value) => constants_1.ALLOWED_LOGO_MIME_TYPES.includes(value);
/**
 ...
 */
const readDimensions = (buffer, mimeType) => {
    try {
 ...
 */
const validateImageBuffer = (buffer, declaredMimeType) => {
    var _a, _b;
    if (!buffer || buffer.length === 0) {
        return { ok: false, message: "El archivo está vacío" };
    }
    if (buffer.length > constants_1.MAX_LOGO_BYTES) {
    ...
    if (dimensions) {
        ...
        if (width > constants_1.MAX_LOGO_DIMENSION || height > constants_1.MAX_LOGO_DIMENSION) {
            return {
                ok: false,
                message: `La imagen no puede superar los ${constants_1.MAX_LOGO_DIMENSION}x${constants_1.MAX_LOGO_DIMENSION} píxeles`
            };
        }
    }
    return {
        ok: true,
        mimeType: detected,
        width: (_a = dimensions === null || dimensions === void 0 ? void 0 : dimensions.width) !== null && _a !== void 0 ? _a : 0,
        height: (_b = dimensions === null || dimensions === void 0 ? void 0 : dimensions.height) !== null && _b !== void 0 ? _b : 0
    };
};
